...
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(MakeRelayCommandRefactoring))]
    internal class MakeRelayCommandRefactoring : CodeRefactoringProvider
    {
        public async sealed override Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            var action = CodeAction.Create("Implement RelayCommand<T>", c => RebuildClassAsync(context.Document, classDecl, c));
